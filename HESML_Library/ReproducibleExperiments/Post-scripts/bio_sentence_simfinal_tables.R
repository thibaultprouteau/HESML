...
# ---------------------------------------------------------------------
# String-based measures experiments
# ---------------------------------------------------------------------
...
outputDir =  paste(rootDir, "/", experimentSubdirectory, "/", sep = "")
...
print(xtable(table_latex, caption = strCaption, digits=3, method = "compact"), caption.placement = 'top', 
      add.to.row = addtorow, file=paste(outputDir,"table_allMetrics_experiment.tex", sep=""), comment=FALSE, size="\\tiny", table.placement="!h", sanitize.colnames.function = identity)
